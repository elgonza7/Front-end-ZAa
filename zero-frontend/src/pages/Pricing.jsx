...
const PLAN_FEATURES = {
  Básico: ['1 número de WhatsApp', 'Flujo de conversación completo', 'Base de conocimiento (PDF)', 'Soporte por email'],
  Profesional: [
    ...
    <div className="min-h-screen bg-[#0d1117]">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-12 pt-20 text-center">
        ...
        <p className="mt-4 text-base text-[#8b949e]">
          ...
          cuántos tokens de IA consume tu asistente.
        </p>
      </section>
        ...
        <Card className="p-6">
          ...
          <div className="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-white">2. Cuota mensual por tokens</p>
                <p className="mt-1 text-xs text-[#8b949e]">
                  Todos los meses se renueva tu cupo de tokens de IA según el plan. Podés pagar con
                  Mercado Pago o por transferencia (alias/CVU en pesos, alias/CBU en dólares).
                </p>
              </div>
            </div>
          </div>
