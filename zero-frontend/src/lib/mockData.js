...
// Precio base por plan, en USD. billingType decide qué precio final se aplica.
// setupFeeUSD es un pago único de habilitación (una sola vez, al contratar);
// priceUSD es el cargo recurrente mensual por uso de tokens.
export const PLAN_PRICING = {
  Básico: { setupFeeUSD: 60, priceUSD: 25, tokensLimit: 5000 },
  Profesional: { setupFeeUSD: 90, priceUSD: 45, tokensLimit: 10000 },
  Premium: { setupFeeUSD: 150, priceUSD: 70, tokensLimit: 20000 },
}
...
export const mockSystemStatus = {
  ...
  components: [
    ...
    { name: 'Motor de IA (OpenAI)', status: 'OPERATIONAL' },
