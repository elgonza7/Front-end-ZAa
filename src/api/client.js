...
// ({ token, role, labId }) — se llama una sola vez, desde authService.login().
export function setAuthSession({ token, role, labId }) {
  setAuthToken(token)
...
export function clearAuthSession() {
  setAuthSession({ token: null, role: null, labId: null })
}
